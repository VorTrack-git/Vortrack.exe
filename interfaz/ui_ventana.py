...
# Los íconos viven en recursos/logos/ (raíz del repo, dos niveles arriba de interfaz/).
_DIR_LOGOS = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "recursos", "logos")
...
def set_window_icon(root):
    ...
    inicializarse.
    """
    ico = os.path.join(_DIR_LOGOS, "VorTrack.ico")
    png = os.path.join(_DIR_LOGOS, "VorTrack_icon_transparent.png")
    if not os.path.exists(png):
        png = os.path.join(_DIR_LOGOS, "VorTrack icon.png")
